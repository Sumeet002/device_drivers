/*Displays kernel tick rate, the value of the HZ macro that defines the rate of context switching*/
...
hz_init(void)
{
    ...
    proc_create("hz", 0, NULL, &hz_fops);     // 0 is default value of file permissions of 0444
    return 0;
}
